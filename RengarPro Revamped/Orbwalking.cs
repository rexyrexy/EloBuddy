...
namespace RengarPro_Revamped
{
    ...
    public static class Orbwalking
    {
        ...
        ///     The champion name
        /// </summary>
        public static string _championName;
        ...
        /// </summary>
        /// <param name="target">The target.</param>
        public static void FireBeforeAttack(AttackableUnit target)
        {
        ...
        /// <param name="unit">The unit.</param>
        /// <param name="target">The target.</param>
        public static void FireOnAttack(AttackableUnit unit, AttackableUnit target)
        {
            if (OnAttack != null)
            {
        ...
        /// </summary>
        /// <param name="minion">The minion.</param>
        public static void FireOnNonKillableMinion(AttackableUnit minion)
        {
        ...
        /// </summary>
        /// <param name="newTarget">The new target.</param>
        public static void FireOnTargetSwitch(AttackableUnit newTarget)
        {
        ...
        public static void Obj_AI_Base_OnDoCast_Delayed(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
        ...
        public static void OnProcessSpell(Obj_AI_Base unit, GameObjectProcessSpellCastEventArgs Spell)
        {
            try
            {
