...
namespace SCommon.Database
{
    public static class Data
    {
        ...
        {
            return unit.Buffs.Any(p => IsImmobilizeBuff(p.Type))  || !unit.CanMove;
        }

        public static bool IsActive(this SpellSlot s)
        {
            return ObjectManager.Player.Spellbook.GetSpell(s).ToggleState == 2;
        }
