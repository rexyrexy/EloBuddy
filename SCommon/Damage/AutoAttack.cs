    ...
    public static class AutoAttack
    {
        ...
        static AutoAttack()
        {
            ...
            ItemPassives.Add(
                ...
                {
                    ItemID = 1043,
                    GetDamage = (s, t) => (float)s.CalculateDamageOnUnit(t, DamageType.Physical, 15)
                });
            ...
            ItemPassives.Add(
                new ItemPassive
                {
                    ...
                    GetDamage = (s, t) =>
                        {
                            var dmg = (float)s.CalculateDamageOnUnit(t, DamageType.Physical, t.Health * 0.06f);
                            if (dmg < 10)
                                dmg = 10;
            ...
            ItemPassives.Add(
                ...
                {
                    ItemID = 3091,
                    GetDamage = (s, t) => (float)s.CalculateDamageOnUnit(t, DamageType.Magical, 42)
                });
            ...
            ItemPassives.Add(
                ...
                {
                    ItemID = 3115,
                    GetDamage = (s, t) => (float)s.CalculateDamageOnUnit(t, DamageType.Magical, 15 + ObjectManager.Player.BaseAbilityDamage * 15 / 100)
                });
            ...
            AAEnpowers[Data.GetID("Caitlyn")].Add(
                new AAEnpower
                {
                    ...
                    GetDamage =
                        (source, target) =>
                        ((float)
                         source.CalculateDamageOnUnit(
                             target,
                             DamageType.Physical,(float)(
            ...
            AAEnpowers[Data.GetID("Ekko")].Add(
                new AAEnpower
                {
                    ...
                    GetDamage = (source, target) =>
                     (float)source.CalculateDamageOnUnit(target, DamageType.Magical, (float)(10 + (source.Level * 10) + (source.BaseAbilityDamage * 0.8)))
                });
            ...
            AAEnpowers[Data.GetID("Ekko")].Add(
                new AAEnpower
                {
                    ...
                    GetDamage = (source, target) =>
                        {
                            float dmg = (float)source.CalculateDamageOnUnit(target, DamageType.Magical, (float)((target.MaxHealth - target.Health) * (5 + Math.Floor(source.BaseAbilityDamage / 100) * 2.2f) / 100));
                    ...
                    GetDamage =
                        ...
                        ((float)
                         source.CalculateDamageOnUnit(
                             target,
                             DamageType.Physical,
                             (float)(0.1d * (source.BaseAttackDamage + source.FlatPhysicalDamageMod)))),
                ...
                new AAEnpower
                {
                    ...
                    GetDamage =
                        ...
                        source.CalculateDamageOnUnit(
                            target,
                            DamageType.Magical,
                            (float)0.15 * source.BaseAbilityDamage
            ...
            AAEnpowers[Data.GetID("Rengar")].Add(
                new AAEnpower
                {
                    ...
                    GetDamage = (source, target) => (float)source.CalculateDamageOnUnit(target, DamageType.Physical, new int[] { 30, 60, 90, 120, 150 }[source.Spellbook.GetSpell(SpellSlot.Q).Level - 1] + (source.BaseAttackDamage + source.FlatPhysicalDamageMod) * new int[] { 0, 5, 10, 15, 20 }[source.Spellbook.GetSpell(SpellSlot.Q).Level - 1] / 100f)
                });
            ...
            AAEnpowers[Data.GetID("Rengar")].Add(
                new AAEnpower
                {
                    ...
                    GetDamage = (source, target) => (float)source.CalculateDamageOnUnit(target, DamageType.Physical, new int[] { 30, 45, 60, 75, 90, 105, 120, 135, 150, 160, 170, 180, 190, 200, 210, 220, 230, 240 }[source.Level - 1] + (source.BaseAttackDamage + source.FlatPhysicalDamageMod) * 0.5f)
                });
                    ...
                    GetDamage =
                        ...
                        ((float)
                         source.CalculateDamageOnUnit(
                             ...
                             new[]
                                     {
                                         (float)0.2, (float)0.2, (float)0.25, (float)0.25, (float)0.25, (float)0.3, (float)0.3, (float)0.3, (float)0.35, (float)0.35, (float)0.35, (float)0.4, (float)0.4, (float)0.4, (float)0.45,
                                         (float)0.45, (float)0.45, (float)0.5
                                     }[source.Level - 1]
                    ...
                    GetDamage =
                        ...
                        (
                         source.CalculateDamageOnUnit(
                             target,
                             DamageType.Magical,
                             (float)(source.Spellbook.GetSpell(SpellSlot.E).Level * 10 + source.BaseAbilityDamage * 0.3))),
            ...
            AAEnpowers[Data.GetID("TwistedFate")].Add(
                new AAEnpower
                {
                        ...
                        GetDamage = (source, target) => (float)Math.Floor(source.CalculateDamageOnUnit(target, DamageType.Magical, new int[] { 55, 80, 105, 130, 155 }[source.Spellbook.GetSpell(SpellSlot.E).Level - 1] + source.BaseAbilityDamage * 0.5f)),
                });
            ...
            AAEnpowers[Data.GetID("Vayne")].Add(
                new AAEnpower
                {
                    ...
                    GetDamage = (source, target) =>
                    {
                        float dmg = target.MaxHealth * (0.06f + 0.015f * (source.Spellbook.GetSpell(SpellSlot.W).Level - 1));
                        if (!(target is AIHeroClient) && dmg > 200)
                            dmg = 200;

                        if (dmg < 40 + 20 * (source.Spellbook.GetSpell(SpellSlot.W).Level - 1))
                            dmg = 40 + 20 * (source.Spellbook.GetSpell(SpellSlot.W).Level - 1);
                ...
                new AAEnpower
                {
                    ...
                    GetDamage =
                        ...
                        source.CalculateDamageOnUnit(
                            target,
                            DamageType.Magical,
                            (float)0.5d * source.BaseAbilityDamage
                ...
                new AAEnpower
                {
                    ...
                    GetDamage =
                        ...
                        source.CalculateDamageOnUnit(
                            target,
                            DamageType.Magical,
                            (float)0.25d * source.BaseAbilityDamage
        ...
        public static float GetDamage(Obj_AI_Base target, bool passiveCheck = false)
        {
            ...
            if (target.Type == GameObjectType.obj_AI_Minion)
                ...
                dmg = (float)ObjectManager.Player.CalculateDamageOnUnit(target, DamageType.Physical, k + (passiveCheck ? PassiveFlatMod(ObjectManager.Player, target) : 0));
            if (hero.ChampionName == "Azir")
            {
                ...
                if (cnt > 0)
                {
                    dmg = (float)hero.CalculateDamageOnUnit(target, DamageType.Magical, new[] { 50, 55, 60, 65, 70, 75, 80, 85, 90, 100, 110, 120, 130, 140, 150, 160, 170, 180 }[ObjectManager.Player.Level - 1] + 0.6f * hero.BaseAbilityDamage);
            ...
            if (passiveCheck)
            {
                if (AAEnpowers[ObjectManager.Player.NetworkId] != null)
                    dmg += AAEnpowers[ObjectManager.Player.NetworkId].Where(p => p.IsActive(hero, target)).Sum(passive => passive.GetDamage(hero, target));

                dmg += ItemPassives.Where(p => Item.HasItem(p.ItemID)).Sum(passive => passive.GetDamage(hero, target));
            }
